<template>
  <div class="home">
    <h1>My Tags</h1>
    <p>
      These are the tags that you have requested. To expand your search to all tags attached
      to your mail code, <router-link to="/asset-tags/w10">click here</router-link>.
    </p>
    <hr />
